...
int F_generic(const T** arg, T** res) {
    ...
    /// Contact elements
    /// Parameters
    osim_double_adouble radiusSphere_s1 = 0.048;
    osim_double_adouble radiusSphere_s2 = 0.039207;
    osim_double_adouble radiusSphere_s3 = 0.016006;
    osim_double_adouble radiusSphere_s4 = 0.028814;
    osim_double_adouble radiusSphere_s5 = 0.046559;
    osim_double_adouble radiusSphere_s6 = 0.030695;
    ...
    Vec3 locSphere_1_r(0.0035613, -0.021859, 0.012288);
    Vec3 locSphere_2_r(0.17339, -0.021859, -0.0037135);
    Vec3 locSphere_3_r(0.11755, -0.021859, 0.026721);
    Vec3 locSphere_4_r(0.057046, -0.021448, -0.0071363);
    Vec3 locSphere_5_r(0.041235, -0.021859, 0.0015407);
    Vec3 locSphere_6_r(0.03191, -0.021448, 0.036857);
    Vec3 locSphere_1_l(0.0035613, -0.021859, -0.012288);
    Vec3 locSphere_2_l(0.17339, -0.021859, 0.0037135);
    Vec3 locSphere_3_l(0.11755, -0.021859, -0.026721);
    Vec3 locSphere_4_l(0.057046, -0.021448, 0.0071363);
    Vec3 locSphere_5_l(0.041235, -0.021859, -0.0015407);
    Vec3 locSphere_6_l(0.03191, -0.021448, -0.036857);
    ...
    HC_4_l = new HuntCrossleyForce_smooth("sphere_4_l", "toes_l", locSphere_4_l, radiusSphere_s4,
        stiffness, dissipation, staticFriction, dynamicFriction, viscousFriction, transitionVelocity, normal, offset);
    HC_5_l = new HuntCrossleyForce_smooth("sphere_5_l", "calcn_l", locSphere_5_l, radiusSphere_s5,
        stiffness, dissipation, staticFriction, dynamicFriction, viscousFriction, transitionVelocity, normal, offset);
    ...
    HC_4_r = new HuntCrossleyForce_smooth("sphere_4_r", "toes_r", locSphere_4_r, radiusSphere_s4,
        stiffness, dissipation, staticFriction, dynamicFriction, viscousFriction, transitionVelocity, normal, offset);
    HC_5_r = new HuntCrossleyForce_smooth("sphere_5_r", "calcn_r", locSphere_5_r, radiusSphere_s5,
        stiffness, dissipation, staticFriction, dynamicFriction, viscousFriction, transitionVelocity, normal, offset);
