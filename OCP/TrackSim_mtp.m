...
idx_ww = 30; % Index row in matrix settings
...
trackSubtID = settings(ww,14);  % subject index
% Trials
...
if (cs == 5 && csc == 3) || (cs == 4 && csc == 3) || (cs == 6 && csc == 4) || (cs == 6 && csc == 5) || (cs == 6 && csc == 6) || (cs == 6 && csc == 7)
...
residuals_act_bsubtmtpi = [jointi.hip_flex.l:jointi.ankle.r,...
    jointi.trunk.ext:jointi.elb.r];
...
viscousFriction = 0.5; 
stif = 1000000;  
if (cs == 6 && csc == 4) || (cs == 6 && csc == 5) || (cs == 6 && csc == 6) || (cs == 6 && csc == 7)
    loc.s1.y = -0.01;
    loc.s2.y = -0.01;
    loc.s3.y = -0.01;
    loc.s4.y = -0.01;
...
%             end   
            ...
            if (cs == 6 && csc == 4) || (cs == 6 && csc == 5) || (cs == 6 && csc == 6) || (cs == 6 && csc == 7) % Sphere 4 => calcn 
            ...
            if cs == 5 || cs == 6
                if csc == 1 % Sphere 5 => calcn
                    ...
                    force_s5_r = f_contactForce(stif,paramsCM_nsc(radi.s5),...
                        ...
                        outk1(calcn.TR.T.r)); 
                elseif csc == 2 || csc == 3 || csc == 4 || csc == 5 || csc == 6 || csc == 7 % Sphere 5 => toes
                    force_s5_l = f_contactForce(stif,paramsCM_nsc(radi.s5),...
                        dissipation,normal,transitionVelo,staticFriction,...
                        dynamicFriction,viscousFriction,locSphere_s5_l,...
                        outk1(toes.l.pos),outk1(toes.l.v_lin),...
    ...
    %                   W.a*B(j+1)*(f_J2(e_mtpk))*h + ...
                elseif trackSubtID == 0
                    J = J + ...
                        ...
                        W.GRM*B(j+1)*(f_J6((Tk(GRMi.all,1)./scaling(p).p.GRM')-...
                            GRF(p).p.MorGF.allinterp(k+1,2:end)'./scaling(p).p.GRM'))*h +...
                        W.ID_act*B(j+1)*(f_J21((Tk(residuals_act_bsubtmtpi,1)./scaling(p).p.T(1)')-...
                            ID(p).p.allinterp(k+1,residuals_act_bsubtmtpi+1)'./scaling(p).p.T(1)))*h +...
                        W.a*B(j+1)*(f_J92(akj{j}))*h + ...                   
                        W.a*B(j+1)*(f_J8(e_ak))*h + ...
                        W.u*B(j+1)*(f_J31(Ak))*h +...
                        W.u*B(j+1)*(f_J92(vAk))*h +...
