...
% num_set = [1,1,0,0,0,0,0]; % This configuration solves the problem
num_set = [0,1,1,0,1,1,1]; % This configuration analyzes the results
...
elseif IGsel == 2 % Data-informed initial guess
    if IGm == 1 % Data from average walking motion
        ...
        guess = ...
            getGuess_DI_opti(Qs_walk,nq,N,time_IC,NMuscle,jointi,scaling,v_tgt);   
...
if solveProblem
    ...
    for k=1:N
        ...
        % Controls
        dFTtildek_nsc = dFTtilde_nsc(:,k); dFTtildek = dFTtilde(:,k); 
        vAk_nsc = vA_nsc(:,k); vAk = vA(:,k);
        Ak_nsc = A_nsc(:,k); Ak = A(:,k);
        e_ak = e_a(:,k);
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%                         
        ...
        for j=1:d
            ...
            xj_nsc  = [...
                Xk_colloc_nsc(2,j+1); Ak_nsc(1); Xk_colloc_nsc(4,j+1); Ak_nsc(2);...
                Xk_colloc_nsc(6,j+1); Ak_nsc(3); Xk_colloc_nsc(8,j+1); Ak_nsc(4);...
                Xk_colloc_nsc(10,j+1); Ak_nsc(5); Xk_colloc_nsc(12,j+1); Ak_nsc(6);...
                Xk_colloc_nsc(14,j+1); Ak_nsc(7); Xk_colloc_nsc(16,j+1); Ak_nsc(8);...
                Xk_colloc_nsc(18,j+1); Ak_nsc(9); Xk_colloc_nsc(20,j+1); Ak_nsc(10);...
                Xk_colloc_nsc(22,j+1); Ak_nsc(11); Xk_colloc_nsc(24,j+1); Ak_nsc(12);...
                Xk_colloc_nsc(26,j+1); Ak_nsc(13); Xk_colloc_nsc(28,j+1); Ak_nsc(14);...
                Xk_colloc_nsc(30,j+1); Ak_nsc(15); Xk_colloc_nsc(32,j+1); Ak_nsc(16);...
                Xk_colloc_nsc(34,j+1); Ak_nsc(17); Xk_colloc_nsc(36,j+1); Ak_nsc(18);...
                Xk_colloc_nsc(38,j+1); Ak_nsc(19); Xk_colloc_nsc(40,j+1); Ak_nsc(20);...
                Xk_colloc_nsc(42,j+1); Ak_nsc(21); Xk_colloc_nsc(44,j+1); Ak_nsc(22);...
                Xk_colloc_nsc(46,j+1); Ak_nsc(23); Xk_colloc_nsc(48,j+1); Ak_nsc(24); ...
                Xk_colloc_nsc(50,j+1); Ak_nsc(25); Xk_colloc_nsc(52,j+1); Ak_nsc(26); ...
                Xk_colloc_nsc(54,j+1); Ak_nsc(27); Xk_colloc_nsc(56,j+1); Ak_nsc(28); ...
                Xk_colloc_nsc(58,j+1); Ak_nsc(29);];
            opti.subject_to((h*xj_nsc - xp_nsc)./scaling.QsQdots' == 0)  
