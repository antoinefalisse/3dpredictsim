...
%% Import data
% lMT
lMT = importdata([path_resultsMA,'subject2_MuscleAnalysis_Length.sto']);
% hip flexion r
MA.hip.flex = importdata([path_resultsMA,'subject2_MuscleAnalysis_MomentArm_hip_flexion_r.sto']);
% hip adduction r
MA.hip.add = importdata([path_resultsMA,'subject2_MuscleAnalysis_MomentArm_hip_adduction_r.sto']);
% hip rotation r
MA.hip.rot = importdata([path_resultsMA,'subject2_MuscleAnalysis_MomentArm_hip_rotation_r.sto']);
% knee flexion r 
MA.knee.flex = importdata([path_resultsMA,'subject2_MuscleAnalysis_MomentArm_knee_angle_r.sto']);
% ankle flexion r
MA.ankle.flex = importdata([path_resultsMA,'subject2_MuscleAnalysis_MomentArm_ankle_angle_r.sto']);
% subtalar r
MA.sub = importdata([path_resultsMA,'subject2_MuscleAnalysis_MomentArm_subtalar_angle_r.sto']);
% mtp r
MA.mtp = importdata([path_resultsMA,'subject2_MuscleAnalysis_MomentArm_mtp_angle_r.sto']);
% lumbar extension
MA.trunk.ext = importdata([path_resultsMA,'subject2_MuscleAnalysis_MomentArm_lumbar_extension.sto']);
% lumbar bending
MA.trunk.ben = importdata([path_resultsMA,'subject2_MuscleAnalysis_MomentArm_lumbar_bending.sto']);
% lumbar rotation
MA.trunk.rot = importdata([path_resultsMA,'subject2_MuscleAnalysis_MomentArm_lumbar_rotation.sto']);
